...
exports.addToRequestBuffer = function(opcode, key, extras, value, opaque, buf, _bufTargetWriteOffset) {
  key = bufferify(key);
  ...
  function appendToBuffer(toWriteBuffer) {
  ...
  appendToBuffer(headerBuffer);
  appendToBuffer(extras);
  appendToBuffer(key);
...
exports.makeRequestBuffer = function(opcode, key, extras, value, opaque) {
  ...
  buf.fill();
  exports.addToRequestBuffer(opcode, key, extras, value, opaque, buf);
  return buf;
};
